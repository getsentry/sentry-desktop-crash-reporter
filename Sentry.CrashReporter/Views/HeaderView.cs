                            ...
                            new WrapPanel()
                                ...
                                .Children(
                                    new IconLabel(FA.Bug)
                                        .Margin(8, 4)
                                        .AutomationProperties(automationId: "exceptionText")
                                    ...
                                    new IconLabel(FA.Globe)
                                        .Margin(8, 4)
                                        .ToolTip("Release")
                                        .AutomationProperties(automationId: "releaseText")
